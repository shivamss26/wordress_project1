...
$default = marsh_music_get_default_theme_options();

// Add Panel.
$wp_customize->add_panel( 'theme_option_panel',
	array(
	'title'      => __( 'Theme Options', 'marsh-music' ),
	'priority'   => 100,
...
'title'       => __('Layout Option', 'marsh-music'),
...
$wp_customize->add_setting('theme_options[layout_options_blog]', 
	...
	'type'              => 'theme_mod',
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'marsh_music_sanitize_select'
	)
);

$wp_customize->add_control(new marsh_music_Image_Radio_Control($wp_customize, 'theme_options[layout_options_blog]', 
	array(		
	'label' 	=> __('Blog Layout', 'marsh-music'),
...
$wp_customize->add_control(new marsh_music_Image_Radio_Control($wp_customize, 'theme_options[layout_options_archive]', 
	array(		
	'label' 	=> __('Archive Layout', 'marsh-music'),
	'section' 	=> 'section_general',
...
$wp_customize->add_control(new marsh_music_Image_Radio_Control($wp_customize, 'theme_options[layout_options_page]', 
	array(		
	'label' 	=> __('Page Layout', 'marsh-music'),
	'section' 	=> 'section_general',
...
$wp_customize->add_control(new marsh_music_Image_Radio_Control($wp_customize, 'theme_options[layout_options_single]', 
	array(		
	'label' 	=> __('Single Post Layout', 'marsh-music'),
	'section' 	=> 'section_general',
...
$wp_customize->add_section('section_excerpt_length', 
	array(    
	'title'       => __('Excerpt Length', 'marsh-music'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_setting( 'theme_options[excerpt_length]', array(
	...
	'sanitize_callback' => 'marsh_music_sanitize_number_range',
) );
$wp_customize->add_control( 'theme_options[excerpt_length]', array(
	'label'       => __( 'Excerpt Length', 'marsh-music' ),
	'description' => __( 'in words', 'marsh-music' ),
...
$wp_customize->add_section('section_blog_title', 
	array(    
	'title'       => __('Blog Title', 'marsh-music'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[your_latest_posts_title]',
	array(
	'label'    => __( 'Blog Title', 'marsh-music' ),
...
$wp_customize->add_section('section_read_more', 
	array(    
	'title'       => __('Read More Text', 'marsh-music'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_setting( 'theme_options[readmore_text]',
	...
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'marsh_music_sanitize_textarea_content',
	'transport'         => 'refresh',
	)
);
$wp_customize->add_control( 'theme_options[readmore_text]',
	array(
	'label'    => __( 'Read More Text', 'marsh-music' ),
...
$wp_customize->add_section('section_footer', 
	array(    
	'title'       => __('Footer Setting', 'marsh-music'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[copyright_text]',
	array(
	'label'    => __( 'Copyright Text', 'marsh-music' ),
...
$wp_customize->add_setting( 'theme_options[disable_frontpage_header_image]', array(
	...
	'sanitize_callback'   => 'marsh_music_sanitize_checkbox',
) );

$wp_customize->add_control( 'theme_options[disable_frontpage_header_image]', array(
	'label'       	=> esc_html__( 'Disable in Front Page Only', 'marsh-music' ),
